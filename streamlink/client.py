...
import time
import os
from lib.afreeca_broads import AfreecaBroad
from lib.twitch_broads import TwitchBroad
from target import twitch_target, afreeca_target
...
class BroadClient:
    ...
    def process(self):
        if self._DEBUG:
            ...
            schedule.every(1).minutes.do(self.signal)
